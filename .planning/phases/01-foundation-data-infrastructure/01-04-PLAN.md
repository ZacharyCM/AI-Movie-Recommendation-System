...
Purpose: The frontend cannot call TMDB directly (API key must stay server-side). These endpoints provide the data layer for the catalog browse page, search, and movie detail page built in Plan 05.
...
- Response shapes match frontend TypeScript types from Plan 02
</verification>
